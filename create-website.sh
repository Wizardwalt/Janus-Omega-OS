#!/bin/bash
echo "=== Creating website folder and files ==="

mkdir -p website

# Beautiful main landing page
...
echo "✅ Website folder and files created successfully."
echo "Next: Commit and enable GitHub Pages"
