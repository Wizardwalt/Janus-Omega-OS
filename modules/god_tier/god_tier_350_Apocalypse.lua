-- god_tier_350_Apocalypse.lua
-- GOD TIER MODULE #350 of 1000
-- The most powerful and mythic tools in existence

function execute(target, options)
    overseer_speak("GOD TIER MODULE 350 ACTIVATED.")
    ...
    log_to_blackbox({
        module = "god_tier_350_Apocalypse",
...
function unleash_god_tier_power(target, rotary_value, options)
    print("Unleashing GOD TIER power of god_tier_350_Apocalypse...")
