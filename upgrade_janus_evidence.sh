...
echo "== Upgrading Janus notes/evidence/export system =="

mkdir -p exports attachments
...
echo
echo "== Notes/evidence/export upgrade complete =="
echo "Run:"
echo "  cargo run -p janus-runtime"
echo
echo "Then test:"
echo "  curl -X POST http://127.0.0.1:8080/api/notes/create -H 'Content-Type: application/json' -d '{\"title\":\"Field Note\",\"body\":\"Testing Janus notes.\"}'"
echo "  curl http://127.0.0.1:8080/api/notes"
echo "  curl -X POST http://127.0.0.1:8080/api/evidence/create -H 'Content-Type: application/json' -d '{\"label\":\"Photo Ref\",\"details\":\"Sample evidence entry\",\"attachment_path\":\"attachments/sample.txt\"}'"
echo "  curl http://127.0.0.1:8080/api/evidence"
echo "  curl -X POST http://127.0.0.1:8080/api/export/bundle"
echo "  curl http://127.0.0.1:8080/api/exports"
